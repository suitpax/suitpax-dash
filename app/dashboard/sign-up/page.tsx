      ...
      <div className="flex min-h-screen items-center justify-center p-4 sm:p-8">
        <div className="w-full max-w-md space-y-6">
          ...
          <form className="space-y-4">
            ...
            <button
              type="submit"
              className="flex w-full items-center justify-center gap-2 rounded-xl bg-white/10 hover:bg-white/15 border border-white/10 py-2 px-4 text-sm font-medium text-white transition-colors"
            >
              Create Account
          ...
          <div className="text-center text-sm text-white/70">
            ...
            <Link href="/dashboard/sign-in" className="font-medium text-white hover:underline">
              Sign in
            </Link>
          </div>
