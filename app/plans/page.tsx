  ...
  return (
    <Layout>
      <div className="max-w-6xl mx-auto">
        {/* Header específico de Plans */}
        <div className="bg-black/30 backdrop-blur-sm rounded-xl border border-white/10 p-4 sm:p-6 shadow-sm mb-10">
          <div className="text-center">
            <h1 className="text-2xl sm:text-3xl font-bold text-white mb-3">Choose Your Plan</h1>
