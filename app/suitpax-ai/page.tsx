  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const assistantMessage: Message = {
        ...
        mcpActionTaken: data.mcpActionTaken,
  ...
  return (
    <div className="h-full flex bg-black text-white">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="flex items-center space-x-1">
                  <p className="text-xs text-white/60">MCP Powered</p>
                  <Badge className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 text-green-300 text-xs px-1 py-0 rounded-full">
          ...
          <div className="space-y-3">
            ...
            <div className="p-2 rounded-lg bg-gradient-to-r from-green-500/10 to-emerald-500/10 border border-green-500/20">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-green-300">Auto Language Detection</span>
              </div>
              <p className="text-xs text-green-400/70 mt-1">Detects and responds in your language</p>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col">
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    <div className="flex items-center space-x-1">
                      ...
                      <p className="text-xs text-white/60">Online • Auto Language</p>
                    </div>
                    {thinkingMode && (
        ...
        {/* Enhanced Messages with MCP Actions */}
