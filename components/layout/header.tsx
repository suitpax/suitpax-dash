...
export function Header({ isSidebarCollapsed = true }: HeaderProps) {
  ...
  return (
    <>
      ...
      <header className="fixed top-0 left-0 right-0 h-14 bg-black/95 backdrop-blur-sm border-b border-white/10 z-50 flex items-center justify-between px-4">
        ...
        <div className="flex items-center space-x-3">
          <div className="relative hidden md:block">
            ...
            <input
              type="search"
              placeholder="Search..."
              className="bg-white/5 border border-white/10 text-white/70 text-sm rounded-full pl-10 pr-4 py-1.5 w-[180px] lg:w-[240px] focus:outline-none focus:ring-1 focus:ring-white/20 placeholder:text-white/30"
            />
          </div>
