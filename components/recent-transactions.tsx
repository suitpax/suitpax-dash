...
export function RecentTransactions() {
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-lg font-semibold tracking-tighter">Recent Transactions</CardTitle>
      </CardHeader>
      <CardContent>
          ...
          {transactions.slice(0, 3).map((transaction) => (
            <div key={transaction.id} className="flex items-center">
              ...
              <div className="flex items-center">
                ...
                {transaction.type === "income" ? (
                  <ArrowUpRight className="h-4 w-4 text-emerald-700 dark:text-emerald-400 ml-1" />
                ) : (
