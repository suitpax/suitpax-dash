            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                <div className="inline-flex items-center gap-2 bg-white/5 px-3 py-1 rounded-full">
                  ...
                  <span className="text-sm font-medium text-white">VIP Lounge Access</span>
                </div>
                <div className="inline-flex items-center gap-1 bg-white/5 px-2 py-0.5 rounded-full">
                  <span className="text-xs font-medium text-white/70">Premium</span>
                  <span className="text-xs text-white/50">•</span>
                  <span className="text-xs text-white/70">Business Travel</span>
                </div>
              </div>

              <h1 className="text-xl md:text-2xl font-medium tracking-tighter text-white mb-1.5">
                Book airport lounge access worldwide
              </h1>

              <p className="text-sm text-white/70 mb-3">
                Enjoy premium lounges with complimentary food, drinks, and amenities during your business travel.
              </p>
            </div>
          </div>
        </div>
